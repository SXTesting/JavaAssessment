...
public class Main
{
    ...
    private static void gradeStudent( StudentService studentService, Scanner scanner )
    {
        ...
        float getGrade = scanner.nextFloat();
        if (getGrade > 0 && getGrade < 7) {
            course.setGrade(getGrade);
        }
        else {
            System.out.println("Invalid grade value (Min value: 1 to Max value: 6)");
            return;
        }
